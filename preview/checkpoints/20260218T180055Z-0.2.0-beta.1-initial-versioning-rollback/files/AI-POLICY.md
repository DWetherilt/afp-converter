...
- `projectPlanWorkbook` updates `docs/project-plan-progress.xlsx` via Excel-native scripting by default using `preview/project-plan-progress-data.json` + `tools/WorkbookUpdater.bas`.
