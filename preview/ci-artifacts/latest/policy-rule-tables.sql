...
insert into policy_rule_catalog(rule_id, realm, category, rule_text, source_ref, mutable_by, enabled, updated_at) values
  ...
  ('PM-CONSOLE-005', 'pm', 'console-governance', 'Duplicate stale background pmconsole live sessions must be detected and reported each environment cycle, with cleanup task support.', 'tools/pm_console_cleanup.py;build.gradle:pmConsoleCleanupStaleSessions', 'human', 1, current_timestamp),
  ...
  ('PM-ENV-008', 'pm', 'environment-governance', 'Stale-session persistence warnings must be computed from history with configurable thresholds.', 'tools/pm_console_cleanup.py --warn-threshold', 'human', 1, current_timestamp),
...
insert into pm_data_dictionary(object_name, object_type, realm, definition, source_ref, naming_pattern, updated_at) values
  ...
  ('environment_health_report', 'report', 'pm', 'Environment readiness report including daemon state, visible session telemetry, and duplicate-session diagnostics.', 'tools/environment_health_check.py', 'snake_case', current_timestamp),
  ('pm_console_stale_cleanup_report', 'report', 'pm', 'Stale session detection/cleanup report with warning threshold and consecutive-cycle signals.', 'tools/pm_console_cleanup.py', 'snake_case', current_timestamp),
  ('pm_console_stale_history', 'state_file', 'pm', 'History of stale session counts used for warning threshold evaluation across cycles.', 'tools/pm_console_cleanup.py --history', 'snake_case', current_timestamp),
  ('environment_dashboard_report', 'report', 'pm', 'Compact triage report for environment readiness, visibility, stale-session warning, and policy threshold context.', 'tools/environment_dashboard_report.py', 'snake_case', current_timestamp),
