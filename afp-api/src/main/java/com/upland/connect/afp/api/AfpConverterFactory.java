    ...
    public static AfpConverter create(AfpConverterConfig config, ExecutorService executor)
        ...
        try {
            ...
            if (config.engine() instanceof AfpConverterConfig.CliEngineConfig cli) {
                Class<?> cliAdapterClass = Class.forName("com.upland.connect.afp.engine.CliAfpEngineAdapter");
                ...
                Class<?> inProcAdapterClass = Class.forName("com.upland.connect.afp.engine.InProcAfpEngineAdapter");
            ...
            Class<?> adapterType = Class.forName("com.upland.connect.afp.engine.AfpEngineAdapter");
            Class<?> converterClass = Class.forName("com.upland.connect.afp.engine.DefaultAfpConverter");
