...
def main() -> int:
    ...
    ap.add_argument('--application-db', default='pm/state/application-realm.sqlite')
    ap.add_argument('--pm-db', default='pm/state/pm-realm.sqlite')
    ap.add_argument('--boilerplate-db', default='pm/state/boilerplate-realm.sqlite')
