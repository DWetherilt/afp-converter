...
def main() -> int:
    ...
    parser.add_argument("--base", default="product/afp-converter/preview/checkpoints", help="Checkpoint base directory")
    parser.add_argument(
        "--manifest",
        default="product/afp-converter/preview/documentation-manifest.json",
