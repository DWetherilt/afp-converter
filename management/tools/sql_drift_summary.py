...
def main() -> int:
    ...
    realms = [
        ("application", root / "management/pm/state/application-realm.sqlite"),
        ("pm", root / "management/pm/state/pm-realm.sqlite"),
        ("boilerplate", root / "management/pm/state/boilerplate-realm.sqlite"),
    ]
