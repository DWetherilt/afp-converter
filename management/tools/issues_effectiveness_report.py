...
def main() -> int:
    ...
    parser.add_argument("--issues", required=True, help="Path to management/docs/issues-log.csv")
    parser.add_argument("--tickle", required=True, help="Path to management/pm/reports/issues-log-tickle.json")
    parser.add_argument("--progress", required=True, help="Path to management/docs/project-plan-progress.csv")
    parser.add_argument("--fidelity", required=True, help="Path to product/afp-converter/preview/fidelity-report.json")
