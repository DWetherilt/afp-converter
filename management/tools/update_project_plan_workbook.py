...
def main() -> int:
    ...
    parser.add_argument(
        "--human-approved",
        default="",
        help="Required token to allow overwriting management/docs/project-plan-progress.xlsx"
    )
    ...
    if xlsx_path.as_posix().endswith("management/docs/project-plan-progress.xlsx"):
        if args.human_approved != "I_HAVE_EXPLICIT_HUMAN_APPROVAL":
            raise SystemExit(
                "Refusing to overwrite management/docs/project-plan-progress.xlsx without "
