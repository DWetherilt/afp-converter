...
ok=1
verify_realm "management/pm/state/application-realm.sqlite" "application" || ok=0
verify_realm "management/pm/state/pm-realm.sqlite" "pm" || ok=0
verify_realm "management/pm/state/boilerplate-realm.sqlite" "boilerplate" || ok=0
