...
- `management/tools/init_update_package.sh` (if target includes tools workflow)
- `product/boilerplate/update-packages/README.md` (if target includes external package workflow docs)

4. Update target log by convention:
- append `templates/changelog-entry.md` to `SESSION_CHANGELOG.md` and/or `management/docs/process-evolution-log.md`
...
- `boilerplateSyncWorkbook` generates/refreshes `management/docs/boilerplate-sync-candidates.xlsx`.
