...
2. Ensure `management/pm/workflow/workflow-manifest.json` includes `pmConsoleEnsureLive` in default execute phase.
...
4. Verify `management/pm/policy/policy-rule-tables.sql` contains action/realm-governance execution rules.
