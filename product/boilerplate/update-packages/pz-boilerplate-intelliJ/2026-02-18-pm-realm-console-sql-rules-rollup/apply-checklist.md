...
2. Apply patch:
   - `git apply product/boilerplate/update-packages/pz-boilerplate-intelliJ/2026-02-18-pm-realm-console-sql-rules-rollup/patches/0001-pm-realm-console-sql-rules-rollup.patch`
...
5. Confirm PM artifacts are not emitted under `product/afp-converter/preview/`.
